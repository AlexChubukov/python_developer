...
if __name__ == "__main__":
    PHONE_FORMAT = "+7-916-000-00-11"
    PASSPORT_TYPE = "паспорт"
    PASSPORT_FORMAT = "0000 000000"
    DRIVER_LICENSE_TYPE = "водительские права"
    DRIVER_LICENSE_FORMAT = "00 00 000000"
    ...
    OTHER_GOOD_PARAMS = ("Нурсултан", "Назарбаев", "1900-01-01", "+7-916-111-11-11", "паспорт", "1111 111111")

    #patient = Patient("Kondrat", "Kolovrat", "1978-01-31", "+7-916-000-00-11", "паспорт", "0000/000-000")
    #Patient.create("Кондрат", "Коловрат", "1978-01-31", "+7-916-000-00-00", "паспорт", "4514 000000")
    patient = Patient("Кондрат", "Коловрат", "1978-01-31", "(495)1234567", "заграничный паспорт", "50 1234598")
    #p = Patient.create("Андрей", "Коловрат", "01.31.1978", "89160000000", "водительские права", "99 10 123456")
    # проблема номера 8 927 1234 234
    #print(patient)
    #patient.first_name = 'Иван'
    #print(patient.__dict__)
    #print(patient.first_name)
    patient.birth_date = "1988-01-31"
    patient.phone ="+7 (916) 000-00-11"
    #patient.document_type = ""
    #print(patient)
    #patient.first_name = 'Another'
    #patient.birth_date = 'ABCDEF'
    #setattr(patient, "document_type", "паспорт")
    #print(patient)
    #print(p)
    #print(patient2)
    patient.save()
